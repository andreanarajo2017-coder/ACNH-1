...
final devicesApiProvider = Provider<DevicesApi>((ref) => DevicesApi(ref.watch(authorizedDioProvider)));
final pushServiceProvider = Provider<PushService>((ref) => PushService(ref.watch(devicesApiProvider)));
